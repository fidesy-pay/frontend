...
export function Wallets() {
    ...
    return (
        <div className="mt-8 flex flex-col max-w-md">
            ...
            {data.wallets.items && data.wallets.items.slice(0, 1).map((wallet: { address: string; balance: number; chain: string }) => (
                <div key={wallet.address} className="bg-gradient-to-r from-blue-200 to-purple-200 border border-gray-300 rounded-lg overflow-hidden shadow-lg">
                    ...
                    <div className="px-4 py-2">
                        ...
                        <div className="flex justify-between items-center text-gray-700">
                            <span> <img src={arbitrumLogoUrl} alt="Arbitrum Logo" className="h-8 w-8" /></span>
                            <Balance
                                address={wallet.address}
                                chain={"arbitrum"}
                                token={"ethereum"}
