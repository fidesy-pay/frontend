...
export default function Profile() {
  ...
  if (loading) {
    return <div className="mt-32 w-full flex flex-col items-center">Loading...</div>;
  }
        ...
        <div className="p-6 mt-8 w-full max-w-md custom-shadow rounded-2xl">
          <div className="flex flex-col space-y-5">
            ...
            <div className="flex flex-col text-gray-700">
              ...
              {confirmation && <ConfirmationPopup message="Are you sure?" onConfirm={deactivate} onCancel={() => setConfirmation(false)}/>}
            </div>
          </div>
        </div>
      </div>
